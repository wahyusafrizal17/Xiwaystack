...
@section('title', 'Tambah Sourcecode')

@section('breadcrumb', 'Tambah Sourcecode')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
  <h4 class="mb-0 fw-600" style="color: var(--admin-heading);">Tambah Sourcecode</h4>
...
<div class="admin-card">
  ...
  <div class="admin-card-body p-4">
    <form action="{{ route('admin.sourcecodes.store') }}" method="POST" enctype="multipart/form-data">
      @include('admin.sourcecodes._form', ['sourcecode' => new \App\Models\Sourcecode])
    </form>
  </div>
</div>
@endsection
