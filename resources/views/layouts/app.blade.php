...
<html lang="id" class="scroll-smooth">
  <head>
    ...
    <meta property="og:title" content="@yield('og_title', trim($__env->yieldContent('title', 'Xiwaystack') . ' — Jasa Aplikasi & Skripsi'))">
    <meta property="og:description" content="@yield('og_description', trim($__env->yieldContent('meta_description', 'Xiwaystack — jasa aplikasi web, mobile, skripsi & integrasi API. Konsultasi gratis.')))">
